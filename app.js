...
function setupEvents(){
  ...
  $('saveBtn').addEventListener('click',()=>saveState(false));$('exportBtn').addEventListener('click',exportProject);$('importProject').addEventListener('change',e=>{if(e.target.files[0])importProject(e.target.files[0]);});
